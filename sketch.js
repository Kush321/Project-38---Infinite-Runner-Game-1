...
function setup() {
  ...
  //Create trex
  trex = createSprite(displayHeight/2+100,displayHeight-270,20,50);
  ...
  //Create end stuff
  gameOver = createSprite(displayWidth/2,((displayHeight-150)/2)-100);
  ...
  invisibleGround = createSprite(displayWidth/2,displayHeight-240,400,10);
...
background(180);
 ...
 // console.log(camera.position.x);
  ...
  if(gameState === PLAY){
    ...
    if(keyDown("space")&& trex.y>=invisibleGround.y-40.2){
        trex.velocityY = -(displayHeight/60);
        jumpSound.play();
    }
